package ec.gob.senescyt.usuario.resources.filters;
...
public class HeaderResponseFilter implements ContainerResponseFilter {
    ...
    public ContainerResponse filter(ContainerRequest request, ContainerResponse response) {
        ...
        if (firstSupportedCharset != null) {
            ...
            m.put("Not supported encoding", "[" + firstSupportedCharset.getCharset() + "] is not a valid character set or is not supported by Rexster.  Check the Accept-Charset of the request and the <character-set> setting in rexster.xml");
